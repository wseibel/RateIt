...
public class TopDomainYearDB implements Comparable<TopDomainYearDB>
{
	@PrimaryKey
	...
	public TopDomainYearDB(String url, float averadgeRating, int countOfRatings)
	{
	...
	@Override
	public int compareTo(TopDomainYearDB o) {
		int result = 0;
