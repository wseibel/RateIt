...
public class TopDomainDayDB implements Comparable<TopDomainDayDB>
{
	@PrimaryKey
	...
	public TopDomainDayDB(String url, float averadgeRating, int countOfRatings)
	{
	...
	@Override
	public int compareTo(TopDomainDayDB o) {
		int result = 0;
