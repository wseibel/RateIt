...
public class TopURLYearDB implements Comparable<TopURLYearDB>
{
	@PrimaryKey
	...
	public TopURLYearDB(String url, float averadgeRating, int countOfRatings)
	{
	...
	@Override
	public int compareTo(TopURLYearDB o) {
		int result = 0;
