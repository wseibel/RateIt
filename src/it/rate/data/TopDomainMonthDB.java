...
public class TopDomainMonthDB implements Comparable<TopDomainMonthDB>
{
	@PrimaryKey
	...
	public TopDomainMonthDB(String url, float averadgeRating, int countOfRatings)
	{
	...
	@Override
	public int compareTo(TopDomainMonthDB o) {
		int result = 0;
