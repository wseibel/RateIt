...
public class TopURLDayDB implements Comparable<TopURLDayDB>
{
	@PrimaryKey
	...
	public TopURLDayDB(String url, float averadgeRating, int countOfRatings)
	{
	...
	@Override
	public int compareTo(TopURLDayDB o) {
		int result = 0;
